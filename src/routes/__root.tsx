...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-cream px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl text-foreground">A stitch came loose</h1>
        <p className="mt-2 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Warm Knits — Handmade Crochet Gifts from Delhi" },
      {
        name: "description",
        content:
          "Warm Knits crafts handmade crochet flowers, bouquets, charms, keychains and custom character gifts in Delhi. Tiny gifts, big smiles.",
      },
      { name: "author", content: "Warm Knits Official" },
      { property: "og:title", content: "Warm Knits — Handmade Crochet Gifts" },
      {
        property: "og:description",
        content:
          "Handcrafted crochet gifts, flowers, charms and custom creations. Made with love in Delhi.",
      },
